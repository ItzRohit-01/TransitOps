...
export const FinanceCenter: React.FC = () => {
  ...
  const [vehiclesProfit] = useState<VehicleProfitability[]>([
      ...
      <div className="space-y-8 font-inter">
        ...
        <section className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-5">
          <div className="bg-white border border-slate-200/80 rounded-2xl p-5 shadow-sm">
            ...
            <span className="text-3xl font-black text-slate-950 font-outfit">{formatCurrency(financeKPIs.totalRevenue)}</span>
          ...
          <div className="bg-white border border-slate-200/80 rounded-2xl p-5 shadow-sm">
            ...
            <span className="text-3xl font-black text-slate-950 font-outfit">{formatCurrency(financeKPIs.totalExpenses)}</span>
          ...
          <div className="bg-white border border-slate-200/80 rounded-2xl p-5 shadow-sm border-l-4 border-l-emerald-500">
            ...
            <span className="text-3xl font-black text-emerald-500 font-outfit">{formatCurrency(financeKPIs.netProfit)}</span>
          ...
          <div className="bg-white border border-slate-200/80 rounded-2xl p-5 shadow-sm">
            ...
            <span className="text-3xl font-black text-slate-950 font-outfit">{financeKPIs.fleetROI}%</span>
          ...
          <div className="bg-white border border-slate-200/80 rounded-2xl p-5 shadow-sm">
            ...
            <span className="text-3xl font-black text-slate-950 font-outfit">${financeKPIs.costPerKm}</span>
          ...
          <div className="bg-white border border-slate-200/80 rounded-2xl p-5 shadow-sm">
            ...
            <span className="text-3xl font-black text-slate-950 font-outfit">{formatCurrency(financeKPIs.fuel)}</span>
