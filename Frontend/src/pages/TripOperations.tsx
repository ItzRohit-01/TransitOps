      ...
      <div className="space-y-8 font-inter relative pb-20">
        ...
        <section className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-5">
          ...
          <div className="bg-white border border-slate-200/80 rounded-2xl p-5 shadow-sm flex flex-col justify-between">
            ...
            <div>
              <span className="text-3xl font-black text-slate-900 tracking-tight font-outfit block mb-1">{totalTrips}</span>
            </div>
          </div>
          ...
          <div className="bg-white border border-slate-200/80 rounded-2xl p-5 shadow-sm flex flex-col justify-between">
            ...
            <div>
              <span className="text-3xl font-black text-slate-900 tracking-tight font-outfit block mb-1">{activeTripsCount}</span>
            </div>
          </div>
          ...
          <div className="bg-white border border-slate-200/80 rounded-2xl p-5 shadow-sm flex flex-col justify-between">
            ...
            <div>
              <span className="text-3xl font-black text-slate-900 tracking-tight font-outfit block mb-1">{pendingTripsCount}</span>
            </div>
          </div>
          ...
          <div className="bg-white border border-slate-200/80 rounded-2xl p-5 shadow-sm flex flex-col justify-between">
            ...
            <div>
              <span className="text-3xl font-black text-slate-900 tracking-tight font-outfit block mb-1">{completedTripsCount}</span>
            </div>
          </div>
          ...
          <div className="bg-white border border-slate-200/80 rounded-2xl p-5 shadow-sm flex flex-col justify-between border-l-4 border-l-rose-500">
            ...
            <div>
              <span className="text-3xl font-black text-slate-900 tracking-tight font-outfit block mb-1">{delayedTripsCount}</span>
            </div>
          </div>
          ...
          <div className="bg-white border border-slate-200/80 rounded-2xl p-5 shadow-sm flex flex-col justify-between">
            ...
            <div>
              <span className="text-3xl font-black text-slate-900 tracking-tight font-outfit block mb-1">{utilization}%</span>
            </div>
          </div>
        </section>
            ...
            <div className="relative flex items-center justify-between py-6 px-4">
              ...
              <div className="flex flex-col items-center gap-2.5 z-10">
                ...
                <div className="text-center">
                  ...
                  <span className="text-xs font-black text-slate-800 mt-0.5 block">{pendingTripsCount}</span>
                </div>
              </div>
              ...
              <div className="flex flex-col items-center gap-2.5 z-10">
                ...
                <div className="text-center">
                  ...
                  <span className="text-xs font-black text-slate-800 mt-0.5 block">{activeTripsCount}</span>
                </div>
              </div>
              ...
              <div className="flex flex-col items-center gap-2.5 z-10">
                ...
                <div className="text-center">
                  ...
                  <span className="text-xs font-black text-blue-600 mt-0.5 block">{activeTripsCount}</span>
                </div>
              </div>
              ...
              <div className="flex flex-col items-center gap-2.5 z-10">
                ...
                <div className="text-center">
                  ...
                  <span className="text-xs font-black text-slate-800 mt-0.5 block">{completedTripsCount}</span>
                </div>
              </div>
              ...
              <div className="flex flex-col items-center gap-2.5 z-10">
                ...
                <div className="text-center">
                  ...
                  <span className="text-xs font-black text-slate-800 mt-0.5 block">{cancelledTripsCount}</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-4 bg-white border border-slate-200/80 rounded-2xl p-5 shadow-sm space-y-4">
            <div className="flex justify-between items-center mb-1">
              ...
              <span className="bg-blue-50 text-blue-600 text-[10px] font-extrabold px-2 py-0.5 rounded-full">{activeTripsCount} Live</span>
            </div>
